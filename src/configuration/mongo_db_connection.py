...
# Load the certificate authority file to avoid timeout errors
...
class MongoDBClient:
    """
    MongoDBClient is responsible for establishing a
    ...
    client = None  # Shared client across all MongoDBClient instances
    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        database_name : str, optional
            ...
            Default is set by DATABASE_NAME constant.

        Raises:
        ------
        MyException
            If there is an issue connecting to MongoDB or
            if the environment variable for the MongoDB URL is not set.
        """
        try:
            # Check if a MongoDB client connection has already been
            # established; if not, create a new one
            ...
            # Raise a custom exception with traceback details if
            # connection fails
