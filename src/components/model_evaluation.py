...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[Proj1Estimator]:
        ...
        Description :   Get the model from the production stage.
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            if best_model is not None:
                ...
                logging.info(
                    "F1_Score-Production Model: %s, F1_Score-New Trained Model: %s",
                    best_model_f1_score,
                    trained_model_f1_score,
                )

            tmp_best_model_score = best_model_f1_score or 0.0
