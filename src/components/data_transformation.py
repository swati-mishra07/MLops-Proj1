...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            logging.info(
                "Exited get_data_transformer_object method of "
                "DataTransformation class"
            )
    ...
    def _rename_columns(self, df):
        """Rename columns and ensure integer types for dummy columns."""
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            input_feature_test_df = self._drop_id_column(
                input_feature_test_df
            )
            input_feature_test_df = self._create_dummy_columns(
                input_feature_test_df
            )
            input_feature_test_df = self._rename_columns(
                input_feature_test_df
            )
            logging.info(
            ...
            logging.info(
                "Transformation done end to end to train-test df."
            )

            logging.info(
                "Applying SMOTEENN for handling imbalanced dataset."
            )
            ...
            logging.info(
                "Saving transformation object and transformed files."
            )
