...
class DataValidation:
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        Description :   This method validates the existence of numerical and
            categorical columns
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            if not status:
                ...
                logging.info(
                    "All required columns present in testing dataframe: "
                    f"{status}"
                )
            ...
            if not status:
                ...
                logging.info(
                    "All categorical/int columns present in training "
                    f"dataframe: {status}"
                )
            ...
            if not status:
                ...
                logging.info(
                    "All categorical/int columns present in testing "
                    f"dataframe: {status}"
                )
